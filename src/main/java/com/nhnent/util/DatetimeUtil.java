...
public class DatetimeUtil {
    ...
    private static final Pattern beautifulerPattern = Pattern.compile(
     ...
     */
    public static String beautifuler(String datetime) {
        String[] result = datetime.split("\\s");
        String month = monthMap.get(result[1]);

        Matcher matcher = beautifulerPattern.matcher(datetime);
